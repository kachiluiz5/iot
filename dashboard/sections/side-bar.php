	...
	<div class="sidebar-content">
		<div id="sidebar">
			...
			<ul class="side-menu">
				...
				<li>
					<select id="local-languages">
						<option value="yoruba">Yoruba</option>
						<option value="hausa">Hausa</option>
						<option value="igbo">Igbo</option>
						<option value="fulfulde">Fulfulde (Fulani)</option>
				...
				<!-- Divider-->
				<!-- <li class="divider" data-text="Soil Sence">Soil Sence</li>
			...
			<div class="ads">
				<div class="wrapper">
					...
					<p></p>
					<a href="" class="btn-upgrade">Activate USSD voice Over</a>
				</div>
			</div>
		</div>
